...
describe("poll params", () => {
  ...
  it("treats positive finite numeric poll params as poll creation intent", () => {
    ...
    // Invalid values should not be treated as poll intent
    ...
    // Negative values should not be treated as poll intent
